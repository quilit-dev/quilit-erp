...
<html><head>
  ...
  <style>
    ...
    .head { display: flex; justify-content: space-between; border-bottom: 2px solid var(--text); padding-bottom: 10px; margin-bottom: 18px; }
    .head h1 { font-size: 22pt; margin: 0; letter-spacing: 1px; }
    .meta { font-size: 10pt; color: var(--text-2); text-align: right; }
    ...
    table.kv td.k { color: var(--text-2); width: 35%; }
    .clause { white-space: pre-wrap; font-size: 11pt; }
    ul { margin: 6px 0 6px 18px; padding: 0; }
    .sig { display: flex; justify-content: space-between; margin-top: 50px; }
    .sig .box { width: 45%; }
    .sig .line { border-top: 1px solid #1a1a1a; margin-top: 50px; padding-top: 4px; font-size: 10pt; color: var(--text-2); }
    .badge { display: inline-block; padding: 2px 10px; border-radius: 999px; font-size: 9pt; background: var(--rule); color: var(--text); }
  </style>
</head><body>
  ...
  <div class="head">
    <div>
      ...
      <div style="color:var(--text-2);font-size:10pt;">
  ...
  <p style="margin-top:30px;color:var(--text-3);font-size:9pt;text-align:center;">
